...
<head>
    ...
    <title>View Sponsor Information</title>
    <style>
...
<body>
    ...
    <header>
        <div class="logo">
            <img class="logo" src="images\log.JPG" alt="Sponsor Logo" width="150" height="50">
        </div>
    ...
    <table >
        ...
        <tbody>
            <?php
                ...
                // Fetch sponsor records from the database
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . (isset($row['sponsor_id']) ? $row['sponsor_id'] : '') . "</td>";
                       ...
                       echo "<td><a href='updatesponsor.php'>update</a></td>"; // Update link
                echo "<td><a href='deletesponsor.php'>Delete</a></td>"; // Delete link
                echo "</tr>";
                    }
                } else {
