...
<body>
    ...
    <header>
        <div class="logo">
            <img class="logo" src="images\log.JPG" alt="Booking Logo" width="150" height="50">
        </div>
    </header>
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . (isset($row['booking_id']) ? $row['booking_id'] : '') . "</td>";
                        echo "<td>" . (isset($row['email']) ? $row['email'] : '') . "</td>";
                        echo "<td>" . (isset($row['date']) ? $row['date'] : '') . "</td>";
                        echo "<td>" . (isset($row['event_id']) ? $row['event_id'] : '') . "</td>";
                        echo "<td><a href='updatebooking.php'>update</a></td>"; // Update link
                        echo "<td><a href='deletebooking.php'>Delete</a></td>"; // Delete link
                        echo "</tr>";
                    }
                } else {
